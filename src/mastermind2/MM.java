...
public class MM implements MasterMindInterface {
    ...
    /*
     * New Game method asks the user to type in 4 unique numbers Returns the numbers
     * at the end
     * 
     * @Param unserInput - an array where the 4 numbers entered by the user are
     * stored
     */
    @Override
    public int[] newGame() {
    ...
    public void updateGame(String[][] resultArray, String[] clueArray) {
        ...
        for (int i = 0; i < 10; i++) {
            System.out.println(" ---------------" + "     ----");
            System.out.println("| " + resultArray[i][0] + " | " + resultArray[i][1] + " | " + resultArray[i][2] + " | "
                    + resultArray[i][3] + " | " + "==" + "|" + clueArray[i] + "|");
        }
        System.out.println(" ---------------" + "     ----");
        System.out.println("");
    ...
    public void finalUpdateGame(String[][] resultArray, String[] clueArray, int[] secretCodeArray) {
        System.out.println(" ---------------");
        System.out.println("| " + secretCodeArray[0] + " | " + secretCodeArray[1] + " | " + secretCodeArray[2] + " | "
                + secretCodeArray[3] + " | ");
